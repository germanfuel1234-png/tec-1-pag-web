# f8a4880c-b880-4e75-9d09-0a2eb8e4516f implementation handoff

This archive is the source of truth for turning the design into production code. Start from `Pagina_tec1.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `Pagina_tec1.html`
...
- A single self-contained `Pagina_tec1.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `Pagina_tec1.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `image-6.png`
- `image.png`
- `Inf-programacion.jpg`
- `lighthouse_celu-1.json`
- `lighthouse_celu.json`
- `lighthouse_PC-1.json`
- `lighthouse_PC.json`
- `MMo.jpg`
- `Recorrido.mp4`

## Coding checklist for AI tools
1. Inspect `Pagina_tec1.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
